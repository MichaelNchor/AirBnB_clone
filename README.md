...
- A command interpreter to manipulate data without a visual interface, like in a Shell (perfect for developmenthat shows the final product to everybody: static and dynamic
- A databas file (JSON file)
...
* To Run the console(interstring representation of an instance based on the class name and id.
...
* To Run hbnb(non-interactively): `echo "<command>" | ./console.py`. Example::memo:
	- `echo "help" | ./console.py`
		- It shows the lrestricted to details of that command, when available.
